...
document.getElementById('studiepunten-input').onkeyup = function(e){
	...
	if(studiepunten_result >= 52){
		...
		studiepunten_result_text.parentNode.style.background = 'rgb(67, 160, 71)';
	} else {
		studiepunten_result_text.parentNode.style.background = 'rgb(239, 83, 80)';
	}

	studiepunten_result_text.innerHTML = studiepunten_result;
}